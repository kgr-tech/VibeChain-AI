...
import { Container, Typography, Button, Stack, Card, CardContent, Grid, Chip } from '@mui/material';
import {
...
// Dynamically import ThreeHero to avoid SSR issues with 3D canvas
const ThreeHero = dynamic(() => import('@/components/landing/ThreeHero'), {
    ssr: false,
    loading: () => <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: '#0a0f1a' }} />
});
        ...
        >
            ...
            <div
                style={{
                    ...
                    width: '100%',
                    height: '100%',
                    background: 'radial-gradient(circle at 50% 50%, rgba(59, 130, 246, 0.05) 0%, rgba(15, 23, 42, 0.4) 100%)',
                    zIndex: 1,
                    pointerEvents: 'none',
                }}
            />
